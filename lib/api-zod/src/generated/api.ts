...
export const ExternalGetComparisonResponse = zod.object({
  ...
  "effectiveDate": zod.string().nullish().describe('First day this competitor row\'s price is valid.'),
  "competitorValidTo": zod.string().nullable().describe('Final day this competitor row\'s price is valid, or null when open-ended.'),
  "upcomingCompetitorPrice": zod.number().nullable(),
  ...
  "prayagValidTo": zod.string().nullable(),
...
export const GetPriceFinderSearchResponse = zod.object({
  ...
  "currentEffectiveDate": zod.string().nullable().describe('First day the current MRP is valid (YYYY-MM-DD).'),
...
export const GetPriceFinderProductResponse = zod.object({
  ...
  "competitor": zod.string(),
  "price": zod.number(),
  "effectiveDate": zod.string().nullable().describe('First day the current competitor price is valid (YYYY-MM-DD).'),
  "validTo": zod.string().nullable().describe('Final day the current competitor price is valid, or null when open-ended.'),
  "priceBasis": zod.string().nullable(),
  "upcomingPrice": zod.number().nullable().describe('Earliest scheduled competitor price after today, on the same comparison basis.'),
  "upcomingEffectiveDate": zod.string().nullable(),
...
export const GetAnalysisOpportunitiesResponse = zod.object({
  ...
  "prayagEffectiveDate": zod.string().nullish().describe('First day the current Prayag MRP is valid.'),
  "prayagValidTo": zod.string().nullish().describe('Final day the current Prayag MRP is valid, or null when open-ended.'),
  "upcomingPrayagChangePct": zod.number().nullish().describe('One-decimal current-to-next Prayag change; zero is retained.'),
  "competitorEffectiveDate": zod.string().nullish().describe('First day the current competitor price is valid.'),
  "competitorValidTo": zod.string().nullish().describe('Final day the current competitor price is valid, or null when open-ended.'),
