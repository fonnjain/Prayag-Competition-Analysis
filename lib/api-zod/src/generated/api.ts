...
export const CreateApiKeyResponse = zod.object({
  "key": zod.string().describe('The full API key secret. Shown only once — it cannot be retrieved again.'),
  "apiKey": zod.object({
  "id": zod.number().int(),
  "name": zod.string(),
  "keyPrefix": zod.string().describe('First characters of the key (e.g. \"pryg_a1b2c3…\") for identification. The full secret is never stored or returned after creation.'),
...
export const ExternalGetAnalysisOverviewResponse = zod.object({
  "totalSkus": zod.number().int(),
  "matchedSkus": zod.number().int(),
  "unmatchedSkus": zod.number().int(),
  "coveragePct": zod.number().nullable(),
  "comparableSkus": zod.number().int(),
  "prayagCheaperCount": zod.number().int().describe('SKUs where competitor effective price > Prayag MRP (Prayag cheaper, good).'),
  "prayagCostlierCount": zod.number().int(),
  ...
  "competitorCount": zod.number().int(),
...
export const GetCatalogDataHealthResponse = zod.object({
  ...
  "pricedProducts": zod.number().int(),
  "pendingProducts": zod.number().int(),
  "conflictCount": zod.number().int(),
  "conflicts": zod.array(zod.object({
  "itemCode": zod.string(),
  "conflictingNames": zod.string().nullish(),
  "sources": zod.string().nullish()
})),
  "missingPriceCount": zod.number().int(),
...
export const GetComparisonSummaryResponse = zod.object({
  ...
  "matchedRows": zod.number().int(),
  "comparableRows": zod.number().int(),
  "prayagCheaperCount": zod.number().int(),
  "prayagCheaperPct": zod.number().nullable(),
  "avgDiffPct": zod.number().nullish(),
  "reviewCount": zod.number().int(),
  "ambiguousCount": zod.number().int().optional().describe('Rows whose unit basis (per pc vs per mtr vs per ft) is ambiguous and therefore excluded from KPIs and flagged for manual review.'),
  ...
  "category": zod.string(),
  "comparable": zod.number().int(),
  "prayagCheaper": zod.number().int(),
  "prayagCheaperPct": zod.number().nullable(),
  "avgDiffPct": zod.number().nullish()
}))
})
...
export const AutoAcceptMappingsResponse = zod.object({
  ...
  "matchedIds": zod.array(zod.number().int())
})
...
export const GetAutoAcceptPreviewResponse = zod.object({
  "high": zod.number().int().describe('Rows accepted at \"High only\".'),
  "medium": zod.number().int().describe('Rows accepted at \"Medium & up\".'),
  "low": zod.number().int().describe('Rows accepted at \"All suggestions\".'),
  "total": zod.number().int().describe('Total pending rows in the current filter.')
})
...
export const GetAcceptBatchesResponse = zod.object({
  ...
  "competitor": zod.string().nullish(),
  "competitorPriceIds": zod.array(zod.number().int()),
  "count": zod.number().int(),
  "createdAt": zod.string()
}))
})
...
export const DeleteCatalogCompetitorResponse = zod.object({
  "ok": zod.boolean(),
  "competitor": zod.string(),
  "deleted": zod.number().int().describe('Number of competitor price rows removed.')
})
...
export const ExportAnalysisResponse = zod.unknown()
