 ...
 */
export const getApiKeys = async ( options?: Parameters<typeof customFetch>[1]): Promise<ApiKeyList> => {
 ...
 */
export const createApiKey = async (apiKeyCreate: ApiKeyCreate, options?: Parameters<typeof customFetch>[1]): Promise<ApiKeyCreated> => {
 ...
 */
export const revokeApiKey = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<ApiKey> => {
 ...
 */
export const deleteApiKey = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<OkResponse> => {
 ...
 */
export const externalListProducts = async (params?: ExternalListProductsParams, options?: Parameters<typeof customFetch>[1]): Promise<CatalogProductList> => {
 ...
 */
export const externalGetProduct = async (itemCode: string, options?: Parameters<typeof customFetch>[1]): Promise<CatalogProductDetail> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getExternalGetProductQueryKey(itemCode);
   ...
   return  { queryKey, queryFn, enabled: itemCode !== null && itemCode !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof externalGetProduct>>, TError, TData> & { queryKey: QueryKey }
}
 ...
 */
export const externalGetComparison = async (params?: ExternalGetComparisonParams, options?: Parameters<typeof customFetch>[1]): Promise<ComparisonList> => {
 ...
 */
export const externalGetAnalysisOverview = async ( options?: Parameters<typeof customFetch>[1]): Promise<AnalysisOverview> => {
 ...
 */
export const getCatalogProducts = async (params?: GetCatalogProductsParams, options?: Parameters<typeof customFetch>[1]): Promise<CatalogProductList> => {
 ...
 */
export const getCatalogProduct = async (itemCode: string, options?: Parameters<typeof customFetch>[1]): Promise<CatalogProductDetail> => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetCatalogProductQueryKey(itemCode);
   ...
   return  { queryKey, queryFn, enabled: itemCode !== null && itemCode !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getCatalogProduct>>, TError, TData> & { queryKey: QueryKey }
}
...
export const patchCatalogProductMrp = async (itemCode: string,
    patchCatalogProductMrpBody: PatchCatalogProductMrpBody, options?: Parameters<typeof customFetch>[1]): Promise<PatchCatalogProductMrp200> => {
  ...
  return customFetch<PatchCatalogProductMrp200>(getPatchCatalogProductMrpUrl(itemCode),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(patchCatalogProductMrpBody)
  }
);}
 ...
 */
export const getCatalogFilters = async ( options?: Parameters<typeof customFetch>[1]): Promise<CatalogFilters> => {
 ...
 */
export const getCatalogDataHealth = async ( options?: Parameters<typeof customFetch>[1]): Promise<CatalogDataHealth> => {
 ...
 */
export const resetCatalog = async ( options?: Parameters<typeof customFetch>[1]): Promise<OkResponse> => {
 ...
 */
export const getComparison = async (params?: GetComparisonParams, options?: Parameters<typeof customFetch>[1]): Promise<ComparisonList> => {
 ...
 */
export const getComparisonSummary = async (params?: GetComparisonSummaryParams, options?: Parameters<typeof customFetch>[1]): Promise<ComparisonSummary> => {
 ...
 */
export const getComparisonByProduct = async (params?: GetComparisonByProductParams, options?: Parameters<typeof customFetch>[1]): Promise<ProductComparisonList> => {
 ...
 */
export const getComparisonFilters = async ( options?: Parameters<typeof customFetch>[1]): Promise<ComparisonFilters> => {
 ...
 */
export const getComparisonMatrix = async (params?: GetComparisonMatrixParams, options?: Parameters<typeof customFetch>[1]): Promise<ComparisonMatrix> => {
 ...
 */
export const getMappingReview = async (params?: GetMappingReviewParams, options?: Parameters<typeof customFetch>[1]): Promise<MappingReviewList> => {
 ...
 */
export const bulkUpdateCompetitorMappings = async (bulkMappingUpdate: BulkMappingUpdate, options?: Parameters<typeof customFetch>[1]): Promise<BulkMappingResult> => {
  ...
  return customFetch<BulkMappingResult>(getBulkUpdateCompetitorMappingsUrl(),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(bulkMappingUpdate)
  }
);}
 ...
 */
export const autoAcceptMappings = async (autoAcceptRequest: AutoAcceptRequest, options?: Parameters<typeof customFetch>[1]): Promise<AutoAcceptResult> => {
  ...
  return customFetch<AutoAcceptResult>(getAutoAcceptMappingsUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(autoAcceptRequest)
  }
);}
 ...
 */
export const getAutoAcceptPreview = async (params?: GetAutoAcceptPreviewParams, options?: Parameters<typeof customFetch>[1]): Promise<AutoAcceptPreview> => {
 ...
 */
export const getAcceptBatches = async ( options?: Parameters<typeof customFetch>[1]): Promise<AcceptBatchList> => {
 ...
 */
export const recordAcceptBatch = async (recordAcceptBatchBody: RecordAcceptBatch, options?: Parameters<typeof customFetch>[1]): Promise<AcceptBatch> => {
  ...
  return customFetch<AcceptBatch>(getRecordAcceptBatchUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(recordAcceptBatchBody)
  }
);}
 ...
 */
export const deleteAcceptBatch = async (id: number, options?: Parameters<typeof customFetch>[1]): Promise<AcceptBatchDeleteResult> => {
...
export const updateCompetitorMapping = async (id: number,
    competitorMappingUpdate: CompetitorMappingUpdate, options?: Parameters<typeof customFetch>[1]): Promise<ComparisonRow> => {
  ...
  return customFetch<ComparisonRow>(getUpdateCompetitorMappingUrl(id),
  {
    ...
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(competitorMappingUpdate)
  }
);}
 ...
 */
export const deleteCatalogCompetitor = async (competitor: string, options?: Parameters<typeof customFetch>[1]): Promise<DeleteCompetitorResult> => {
 ...
 */
export const getAnalysisFilters = async ( options?: Parameters<typeof customFetch>[1]): Promise<AnalysisFilters> => {
 ...
 */
export const getAnalysisOverview = async (params?: GetAnalysisOverviewParams, options?: Parameters<typeof customFetch>[1]): Promise<AnalysisOverview> => {
 ...
 */
export const getAnalysisByBrand = async (params?: GetAnalysisByBrandParams, options?: Parameters<typeof customFetch>[1]): Promise<AnalysisBrandStat[]> => {
 ...
 */
export const getAnalysisByCategory = async (params?: GetAnalysisByCategoryParams, options?: Parameters<typeof customFetch>[1]): Promise<AnalysisCategoryStat[]> => {
 ...
 */
export const getAnalysisPositioning = async (params?: GetAnalysisPositioningParams, options?: Parameters<typeof customFetch>[1]): Promise<AnalysisPositioning> => {
 ...
 */
export const getAnalysisCoverageMatrix = async (params?: GetAnalysisCoverageMatrixParams, options?: Parameters<typeof customFetch>[1]): Promise<AnalysisCoverageMatrix> => {
 ...
 */
export const getAnalysisOpportunities = async (params?: GetAnalysisOpportunitiesParams, options?: Parameters<typeof customFetch>[1]): Promise<AnalysisOpportunities> => {
 ...
 */
export const exportAnalysis = async (params?: ExportAnalysisParams, options?: Parameters<typeof customFetch>[1]): Promise<Blob> => {
 ...
 */
export const getDiscountSettings = async ( options?: Parameters<typeof customFetch>[1]): Promise<DiscountSettings> => {
 ...
 */
export const updateDiscountSettings = async (discountSettingsUpdate: DiscountSettingsUpdate, options?: Parameters<typeof customFetch>[1]): Promise<DiscountSettings> => {
  ...
  return customFetch<DiscountSettings>(getUpdateDiscountSettingsUrl(),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(discountSettingsUpdate)
  }
);}
